...
class GetFlickrJsonData implements GetRawDataAsyncTask.OnDownloadComplete {
    ...
    void executeOnSameThread(String searchCriteria) {
        ...
        GetRawDataAsyncTask getRawDataAsyncTask = new GetRawDataAsyncTask(this);
        getRawDataAsyncTask.execute(destinationUri);
